...
public class Board
{
    ...
    //************************************************************
    public void move(int start_row, int start_col, int end_row, int end_col, int value)
    {
	...
	if(validMove(start_row, start_col, end_row, end_col, value)){ 
	    ...
	    System.out.println("That is not a valid move!"+start_row+start_col+end_row+end_col+value);
    }
    ...
    //Returns true or false
    //************************************************************
    public boolean validMove(int start_row, int start_col, int end_row, int end_col, int value)
    {
